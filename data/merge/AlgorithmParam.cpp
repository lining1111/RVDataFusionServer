...
////    printf("objectInfoT.inputID %s objectInfoT.longitude %0.12lf objectInfoT.latitude %0.12lf objectInfoT.directionAngle %0.12lf\n", objectInfoT.inputID.c_str(),
////           objectInfoT.longitude,objectInfoT.latitude,objectInfoT.directionAngle);
//}
//
...
//
////    printf("objID %s objType %d longitude %0.12lf latitude %0.12lf angle %f speed:%f\n",
////           objMix.objID.c_str(), objMix.objType, objMix.longitude, objMix.latitude,
////           objMix.angle, objMix.speed);
//}
...
bool AlgorithmParam::JsonMarshal(Json::Value &out) {
    ...
    out["fusion_min_distance"] = this->fusion_min_distance;
    out["fusion_max_distance"] = this->fusion_max_distance;
...
bool AlgorithmParam::JsonUnmarshal(Json::Value in) {
    ...
    if (in.isMember("fusion_min_distance")) {
        this->fusion_min_distance = in["fusion_min_distance"].asDouble();
    }
    if (in.isMember("fusion_max_distance")) {
        this->fusion_max_distance = in["fusion_max_distance"].asDouble();
    }
