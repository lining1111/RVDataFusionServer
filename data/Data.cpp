...
static void dataUnitHistoryPrint_FusionData(Data *local, int interval) {
...
static void dataUnitHistoryPrint_TrafficFlowGather(Data *local, int interval) {
...
static void dataUnitHistoryPrint_CrossTrafficJamAlarm(Data *local, int interval) {
...
static void dataUnitHistoryPrint_IntersectionOverflowAlarm(Data *local, int interval) {
...
static void dataUnitHistoryPrint_InWatchData_1_3_4(Data *local, int interval) {
...
static void dataUnitHistoryPrint_InWatchData_2(Data *local, int interval) {
...
int Data::startDataUnitHistoryPrint(Data *local, int interval) {
    ...
    while (local->isRun) {
        ...
        std::thread(dataUnitHistoryPrint_FusionData, local, interval).detach();

        //dataUnitHistoryTrafficFlowGather
        std::thread(dataUnitHistoryPrint_TrafficFlowGather, local, interval).detach();

        //dataUnitHistoryCrossTrafficJamAlarm
        std::thread(dataUnitHistoryPrint_CrossTrafficJamAlarm, local, interval).detach();

        //dataUnitHistoryIntersectionOverflowAlarm
        std::thread(dataUnitHistoryPrint_IntersectionOverflowAlarm, local, interval).detach();

        //dataUnitHistoryInWatchData_1_3_4
        std::thread(dataUnitHistoryPrint_InWatchData_1_3_4, local, interval).detach();
